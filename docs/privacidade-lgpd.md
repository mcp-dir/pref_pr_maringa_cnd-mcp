...
Prefeitura PR Maringá: Certidão Negativa de Débitos (Contribuinte) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [pref_pr_maringa_cnd@mcp.ai](mailto:pref_pr_maringa_cnd@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
